...
export default function Footer() {
    return (
        <footer className="bg-white">
            <div className="container mx-auto text-black px-8">
                <div className="w-full flex flex-col md:flex-row py-6">
                    ...
                    <div className="flex-1">
                        <p className="text-gray-500 pt-2 pb-4 uppercase">Links</p>
                        <ul className="mt-2">
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">FAQ</li>
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">Help</li>
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">Support</li>
                        </ul>
                    </div>
                    <div className="flex-1">
                        <p className="text-gray-500 pt-2 pb-4 uppercase">Links</p>
